...
This command fetches the issues and comments from your github repository and stores it in a txt file for backup.

User instructions:
Step 1 : Open your commandline with cUrl installed (Git bash has cUrl inbuilt. I use Git bash for this purpose).
...
(Don't forget to change username, reponame and Issue number according to your need)
